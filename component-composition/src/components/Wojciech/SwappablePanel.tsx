...
export const WojciechPanel: React.FC<PanelProps> = ({
  headerTitle,
  headerIcon,
  ...
  return (
    <div className="panel">
      ...
      <div className="panel-content" style={{ backgroundColor: contentBackgroundColor, color: contentTextColor }}>
        {swapContextWithActionButton ? <button className="panel-content-button" style={{ color: contentButtonColor }}>
          Action
        </button> : <p>{contentText}</p>}
